$( document ).ready(function() {
	...
	var isMobile = null;
 	var template = Handlebars.compile(source);
      ...
      {title:"Expressway", moreInfoAvailable:"inline-block", flipperID: "myFlipper2", url:"/projects/3-expressway.html", workCategory:"which-uxresearch-item which-needfinding-item which-uxdesign-item", imageURL:"assets/img/project_thumbnails/Expressway.png", description:"A series of mobile app games, designed to get kids talking about and telling stories about emotions. Ultimately, this will help with their emotional development."},
      {title:"Rolls of the World", moreInfoAvailable:"inline-block", flipperID:"myFlipper3", url:"/projects/4-rollsoftheworld.html", workCategory:"which-needfinding-item", imageURL:"assets/img/project_thumbnails/mr-sushi.jpg", description:"A series of stuffed toys. Each toy is a rolled-up blanket in the style of a food roll from its home country. These toys allow for multiple types of play and learning."},
      {title:"Toadette", moreInfoAvailable:"inline-block", flipperID:"myFlipper4", url:"/projects/7-toadette.html", workCategory:"which-needfinding-item which-uxresearch-item", imageURL:"assets/img/project_thumbnails/toadette_stool.jpg", description:"My undergraduate senior thesis. An ergonomic stool with the benefits of a yoga ball and the flexibiliy/mobility of an office chair."},
      {title:"Emoticon Chat", moreInfoAvailable:"inline-block", flipperID:"myFlipper10", url:"/projects/5-emoticonvideo.html", workCategory:"which-uxresearch-item which-coding-item which-uxdesign-item", imageURL:"assets/img/project_thumbnails/emoticon-thumb.png", description:"We reimagined a way to express emotions in online communication. After brainstorming and selecting two ideas, we built working prototypes."},
      {title:"Socialize", moreInfoAvailable:"inline-block", flipperID:"myFlipper5", url:"/projects/2-socialize.html", workCategory:"which-coding-item which-uxdesign-item", imageURL:"assets/img/project_thumbnails/Socialize-upcoming-events.jpg", description:"A mobile web app where you can broadcast upcoming plans to dormmates. If desired, friends can RSVP, so others can see who's going."},
      ...
      {title:"A Pen in the Style of Ross Lovegrove", moreInfoAvailable:"inline-block", flipperID:"myFlipper9",url:"/projects/6-pen.html", workCategory:"which-uxdesign-item", imageURL:"assets/img/project_thumbnails/pen.jpg", description:"Industrial design project to design a pen in the style of a designer."},
      {title:"Who are your students?", moreInfoAvailable:"inline-block", flipperID:"myFlipper11", url:"/projects/8-personas.html", workCategory:"which-needfinding-item", imageURL:"assets/img/project_thumbnails/personas-thumbnail.png", description:"Consulting project with a foreign language school for adults in NYC. Surveys and open-ended interviews to define personas and offer product recommenations."},
    ]};

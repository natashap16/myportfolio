$( document ).ready(function() {
	...
	var isMobile = null;
 	var template = Handlebars.compile(source);
  	var data = { projects: [
      {title:"Vincere", moreInfoAvailable:"inline-block", flipperID: "myFlipper1", url:"href=/projects/1-vincere.html", workCategory:"which-uxresearch-item which-coding-item which-uxdesign-item", imageURL: "assets/img/project_thumbnails/vincere.png", styleInfo:"position:relative; top:10px", description:"A site designed to anonymously connect survivors of sexual assault. They would connect over an audio stream and a shared drawing canvas, so they could doodle and create something together while they talk."},
      {title:"Expressway", moreInfoAvailable:"inline-block", flipperID: "myFlipper2", url:"href=/projects/3-expressway.html", workCategory:"which-uxresearch-item which-needfinding-item which-uxdesign-item", imageURL:"assets/img/project_thumbnails/Expressway.png", description:"A series of mobile app games, designed to get kids talking about and telling stories about emotions. Ultimately, this will help with their emotional development."},
      {title:"Rolls of the World", moreInfoAvailable:"inline-block", flipperID:"myFlipper3", url:"href=/projects/4-rollsoftheworld.html", workCategory:"which-needfinding-item", imageURL:"assets/img/project_thumbnails/mr-sushi.jpg", description:"A series of stuffed toys. Each toy is a rolled-up blanket in the style of a food roll from its home country. These toys allow for multiple types of play and learning."},
      {title:"Toadette", moreInfoAvailable:"inline-block", flipperID:"myFlipper4", url:"href=/projects/7-toadette.html", workCategory:"which-needfinding-item which-uxresearch-item", imageURL:"assets/img/project_thumbnails/toadette_stool.jpg", description:"My undergraduate senior thesis. An ergonomic stool with the benefits of a yoga ball and the flexibiliy/mobility of an office chair."},
      {title:"Emoticon Chat", moreInfoAvailable:"inline-block", flipperID:"myFlipper10", url:"href=/projects/5-emoticonvideo.html", workCategory:"which-uxresearch-item which-coding-item which-uxdesign-item", imageURL:"assets/img/project_thumbnails/emoticon-thumb.png", description:"We reimagined a way to express emotions in online communication. After brainstorming and selecting two ideas, we built working prototypes."},
      {title:"Socialize", moreInfoAvailable:"inline-block", flipperID:"myFlipper5", url:"href=/projects/2-socialize.html", workCategory:"which-coding-item which-uxdesign-item", imageURL:"assets/img/project_thumbnails/Socialize-upcoming-events.jpg", description:"A mobile web app where you can broadcast upcoming plans to dormmates. If desired, friends can RSVP, so others can see who's going."},
      {title:"Teacher Time Study at AltSchool", moreInfoAvailable:"none", flipperID:"myFlipper6",url:"", workCategory:"which-uxresearch-item", imageURL:"assets/img/project_thumbnails/time-lapse-altschool.jpg", description:"Observed individual and group classroom activities to explain to broader team what goes on in classroom."},
      {title:"Usability Testing at Google", moreInfoAvailable:"none", flipperID:"myFlipper7",url:"", workCategory:"which-uxresearch-item", imageURL:"assets/img/project_thumbnails/usability-testing-google.jpg", description:"Designed, recruited for, and conducted usability testing for select Google products."},
      {title:"Teacher Planning Study", moreInfoAvailable:"none", flipperID:"myFlipper8",url:"", workCategory:"which-uxresearch-item", imageURL:"assets/img/project_thumbnails/teacher-card-sort.png", description:"Interviewed five teachers. Analyzed to understand and make recommendations for the Personal Learning Plan (PLP), Learner Profile (LP), and general planning."},
      {title:"A Pen in the Style of Ross Lovegrove", moreInfoAvailable:"inline-block", flipperID:"myFlipper9",url:"href=/projects/6-pen.html", workCategory:"which-uxdesign-item", imageURL:"assets/img/project_thumbnails/pen.jpg", description:"Industrial design project to design a pen in the style of a designer."},
      {title:"Who are your students?", moreInfoAvailable:"inline-block", flipperID:"myFlipper11", url:"href=/projects/8-personas.html", workCategory:"which-needfinding-item", imageURL:"assets/img/project_thumbnails/personas-thumbnail.png", description:"Consulting project with a foreign language school for adults in NYC. Surveys and open-ended interviews to define personas and offer product recommenations."},
    ]};
